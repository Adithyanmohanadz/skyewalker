...
(function (window, $) {
  ...
  socialWarfare.emphasizeButtons = function () {
    ...
    jQuery(".swp_social_panel:not(.swp_social_panelSide)").each(function (
      i,
      panel
    ) {
      jQuery(panel)
  ...
  socialWarfare.activateHoverStates = function () {
    ...
    $(".swp_social_panel:not(.swp_social_panelSide) .nc_tweetContainer").on(
      "mouseenter",
      function () {
      ...
      .each(function (index) {
        ...
        if (
          ...
          if (
            index === 0 &&
            theContent.length &&
            theContent.offset().top > scrollPos + $(window).height()
          ) {
            visible = true;
          }
        }
  ...
  socialWarfare.toggleMobileButtons = function () {
    ...
    var visibility = socialWarfare.staticPanelIsVisible()
      ? "collapse"
      : "visible";
  ...
  socialWarfare.toggleFloatingHorizontalPanel = function () {
    ...
    var location = socialWarfare.isMobile()
  ...
  socialWarfare.fetchFacebookShares = function () {
    var url1 =
      "https://graph.facebook.com/v6.0/?fields=og_object{engagement}&id=" +
      swp_post_url;
    var url2 = swp_post_recovery_url
      ? "https://graph.facebook.com/v6.0/?fields=og_object{engagement}&id=" +
